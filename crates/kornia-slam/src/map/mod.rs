//! Map storage, observations, local selection, culling, and world corrections.
//!
//! Point creation and neighbor fusion live in `growth`; bundle adjustment and
//! snapshot merging live in `bundle_adjustment`. `local_mapping` schedules BA.
//!
//! ```text
//!    +--------+
//!    | Frame  |
...
pub use bundle_adjustment::{KeyframeBaCorrection, LocalBaMergeResult, LocalBaSnapshot};
